...
public class BusinessDelegate {
	...
	public void nuevoPedido(PedidoDTO pedido) throws SistemaException, PedidoException, DAOException, ClienteException 
			 {
		try {
	...
	public void aprobarPedido(int nroPedido) {
		try {
			negocioRemoto.aprobarPedido(nroPedido);
		} catch (Exception e) {
